                            ...
                            function o(i) {
                                ...
                                i.addEventListener("click", function (n) {
                                    ...
                                    n.preventDefault(),
                                        ...
                                        ((r = o.variant.id), (a = o.quantity), e.ajax({ type: "POST", url: "/cart/add.js", data: "id=" + r + "&quantity=" + a, dataType: "json" })).done(function () {
                                            t.trigger("addtocart");
                                        });
                                }),
                                    ...
                                    (function (n) {
                                        ...
                                        t.on("cart:change", function (n) {
                                            e.ajax({
                                                ...
                                                type: "GET",
                                                success: function (e) {
                                                    n && 0 === n.items.length ? window.location.reload() : ((i.innerHTML = e), t.trigger("cartdraweritems:update"));
                                                },
                                            });
                                        });
                                    })(n);
